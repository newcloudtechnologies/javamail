...
import static javax.mail.util.BytesUtils.getBytesUTF8;
...
public class SMTPTransport extends Transport {
	...
	void doAuth(String host, String authzid, String user, String passwd)
	    ...
	    // send username
	    resp = simpleCommand(BASE64EncoderStream.encode(getBytesUTF8(user)));
	    if (resp == 334) {
		// send passwd
		resp = simpleCommand(BASE64EncoderStream.encode(getBytesUTF8(passwd)));
	    }
	}
    }
	...
	String getInitialResponse(String host, String authzid, String user,
	    ...
	    if (authzid != null)
		b64os.write(getBytesUTF8(authzid));
	    b64os.write(0);
	    b64os.write(getBytesUTF8(user));
	    b64os.write(0);
	    b64os.write(getBytesUTF8(passwd));
	...
	String getInitialResponse(String host, String authzid, String user,
	    ...
	    String resp = "user=" + user + "\001auth=Bearer " +
			    passwd + "\001\001";
	    byte[] b = BASE64EncoderStream.encode(getBytesUTF8(resp));
